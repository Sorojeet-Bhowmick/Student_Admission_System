...
const Login = ({ isModal = false, onClose = null, onSwitchMode = null }) => {
	...
	const cardContent = (
		<div className="auth-card">
			<header className="auth-header">
				...
				<button type="button" className="auth-header-btn" onClick={() => alert("SecurePortal uses enterprise-grade security protocols to protect student identities.")} aria-label="Information">
					<svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round">
			...
			<p className="auth-subtitle">Access the student admission portal with your secure credentials.</p>
			...
			<div className="auth-social-group">
				...
				<button type="button" className="auth-social-btn" onClick={() => alert("Apple Sign-In is currently in sandbox testing mode.")}>
			...
			<div className="auth-footer">
				...
				{isModal && onSwitchMode ? (
					<button type="button" onClick={onSwitchMode} className="auth-link" style={{border:'none', background:'none', cursor:'pointer', padding:0, fontSize:'inherit', fontWeight:'inherit', fontFamily:'inherit'}}>Create Account</button>
				) : (
